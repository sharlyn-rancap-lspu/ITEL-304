...
class Number(Widget):
    ...
    colors = {
        2: get_color_from_hex('#f7f5bc'),
        4: get_color_from_hex('#f1ee8e'),
        8: get_color_from_hex('#ece75f'),
        16: get_color_from_hex('#e8e337'),
        32: get_color_from_hex('#e5de00'),
        64: get_color_from_hex('#e6cc00'),
        128: get_color_from_hex('#e6b400'),
        256: get_color_from_hex('#e69b00'),
        512: get_color_from_hex('#e47200'),
...
#bulding our background
    def rebuild_background(self):
        ...
        with self.canvas.before:
            ...
            BorderImage(pos=self.pos, size=self.size, source='round.png')
